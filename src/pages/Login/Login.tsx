        ...
        <div className="w-full max-w-md flex flex-col bg-white p-8 rounded-lg border border-[#A4A7B74D] shadow-sm min-h-[50vh]">
          <div className="flex-grow">
            <div className="mb-8">
              ...
              <p className="font-medium text-[#737373] text-[16px] leading-[24px]">
          ...
          <div className="mt-auto pt-8">
            ...
            <div className="text-center text-[14px] text-[#666666]">
              <a
                href="#"
                className="underline hover:text-[#0A74DC] transition-colors"
              >
                Privacy Policy
              </a>{" "}
              <span className="text-[#B0B9C8] mx-2">and</span>{" "}
              <a
                href="#"
                className="underline hover:text-[#0A74DC] transition-colors"
              >
